...
TG_URL         = "http://tamilgun.pro/"
RAJ_CAT_URL    = 'http://www.rajtamil.com/category/'
...
nextpage_img   = 'https://lh3.googleusercontent.com/-6Wk5B3hQuGQ/VTBYBLZPjoI/AAAAAAAACNw/BBpMgKHgPK4/s300/nextpage.png'
...
def parseGunMoviePage( url ):
   ...
   imgRegex = '<div class="image-holder">\s+<img src=" (.+?) "'
   srcTitle = '<h3 class="entry-title"><a href="(.+?)" title=".*">(.*?)</a></h3>'
   navRegex = '<a class="next page-numbers" href="(.*?)">'


   src = re.compile( srcTitle ).findall( html )
   img = re.compile( imgRegex ).findall( html )
   nav = re.compile( navRegex ).findall( html )
...
def Gun_Movie_Menu( url ):
    xbmcplugin.setContent(int(sys.argv[1]), 'movies')
    addon.add_directory( { 'mode' : 'gunmovie', 'url' : TG_URL + '/categories/hd-movies/' }, { 'title' : '[B]HD Movies[/B]' }, img="https://lh3.googleusercontent.com/-3-HUGj_h-o8/VtE7lhahIAI/AAAAAAAADhw/xbm_KTVrt2Q/s512-Ic42/tamilmovies.png" )
    addon.add_directory( { 'mode' : 'gunmovie', 'url' : TG_URL + '/categories/new-movies/' }, { 'title' : '[B]New Movies[/B]' }, img="https://lh3.googleusercontent.com/-3-HUGj_h-o8/VtE7lhahIAI/AAAAAAAADhw/xbm_KTVrt2Q/s512-Ic42/tamilmovies.png" )
    addon.add_directory( { 'mode' : 'gunmovie', 'url' : TG_URL + '/categories/dubbed-movies/' }, { 'title' : '[B]Dubbed Movies[/B]' }, img="https://lh3.googleusercontent.com/-3-HUGj_h-o8/VtE7lhahIAI/AAAAAAAADhw/xbm_KTVrt2Q/s512-Ic42/tamilmovies.png" )
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
    thumbnailView()
#####===END OF TAMILGUN===#####
...
def Main_Categories():
    ...
    addon.add_directory( { 'mode' : 'vijayVOD', 'url' : vijayVODUrl }, { 'title' : '[B]Vijay TV Video ONDEMAND[/B]' },
                        ...
                        fanart=fanartimg )
    addon.add_directory( { 'mode' : 'rajserialmain', 'url' : raj_vijay_serial }, { 'title' : '[B]TV Serials[/B]' },
                        img='https://lh3.googleusercontent.com/-1emFcwTbPT4/VTBYEiecdfI/AAAAAAAACOY/nRL_v6cMP9I/s300-Ic42/serials.png',
                        fanart=fanartimg )
    addon.add_directory( { 'mode' : 'rajshowsmain', 'url' : raj_vijay_shows }, { 'title' : '[B]TV Shows[/B]' },
    ...
    addon.add_directory( { 'mode' : 'rajmovie', 'url' : MOVIE_RAJ_URL }, { 'title' : '[B]Movies - Raj[/B]' },
                        ...
                        fanart=fanartimg )
    addon.add_directory( { 'mode' : 'gunmoviemain', 'url' : MOVIE_GUN_MOVI }, { 'title' : '[B]Movies - TamilGun[/B]' },
...
def Raj_Movie_Main( url ):
    ...
    for ( page, title ), img in link:
        ...
        addon.add_directory( { 'mode' : 'load_gunvideos', 'url' : page , 'iconImg' : img}, { 'title' : title }, img=img, total_items=len(link) )
    if nav:
        addon.add_directory( { 'mode' : 'rajmovie', 'url' : nav }, { 'title' : '[B]Next Page...[/B]' }, img=nextpage_img )
...
def raj_shows_main( url ):
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'vijay-tv-shows/'}, {'title': '[B]Vijay TV Shows[/B]'},
                        img='https://goo.gl/jW5Nd4',
                        fanart=fanartimg)
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'sun-tv-show/'}, {'title': '[B]Sun TV Shows[/B]'},
                        img='https://lh3.googleusercontent.com/-dmQ_Fgo6004/Vu2hxm5OmtI/AAAAAAAADnU/6S7naCAHEJA6MwzyRh1bOeVRw7g6zJ-EgCCo/s300-Ic42/suntvhd.png',
                        fanart=fanartimg)
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'zee-tamil-tv-show/'}, {'title': '[B]Zee Tamil Shows[/B]'},
                        img='https://lh6.googleusercontent.com/-FGvNeJRbIF8/VQptuDN3HpI/AAAAAAAAB4c/1OvslRgP3Ko/s300/zeetamil.png',
                        fanart=fanartimg)
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'polimer-tv-show-2/'}, {'title': '[B]Polimer TV Shows[/B]'},
                        img='https://lh5.googleusercontent.com/-yslSLhHLcO4/VNfK2MuB8XI/AAAAAAAABOg/ntOYiFf_iBM/s300/polimer.png',
                        fanart=fanartimg)
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
    thumbnailView()

def raj_serial_main( url ):
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'vijay-tv-serials/'}, {'title': '[B]Vijay TV Serials[/B]'},
                        img='https://goo.gl/jW5Nd4',
                        fanart=fanartimg)
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'sun-tv-serial/'}, {'title': '[B]Sun TV Serials[/B]'},
                        img='https://lh3.googleusercontent.com/-dmQ_Fgo6004/Vu2hxm5OmtI/AAAAAAAADnU/6S7naCAHEJA6MwzyRh1bOeVRw7g6zJ-EgCCo/s300-Ic42/suntvhd.png',
                        fanart=fanartimg)
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'zeetamil-serial/'}, {'title': '[B]Zee Tamil Serials[/B]'},
                        img='https://lh6.googleusercontent.com/-FGvNeJRbIF8/VQptuDN3HpI/AAAAAAAAB4c/1OvslRgP3Ko/s300/zeetamil.png',
                        fanart=fanartimg)
    addon.add_directory({'mode': 'rajshows', 'url': RAJ_CAT_URL + 'polimer-tv-serial-2/'}, {'title': '[B]Polimer TV Serials[/B]'},
                        img='https://lh5.googleusercontent.com/-yslSLhHLcO4/VNfK2MuB8XI/AAAAAAAABOg/ntOYiFf_iBM/s300/polimer.png',
                        fanart=fanartimg)
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
    thumbnailView()
...
if play:
   ...
   if stream_url:
    ...
    elif mode == 'rajshowsmain':
       raj_shows_main( url )

    elif mode == 'rajserialmain':
       raj_serial_main( url )

    elif mode == 'rajshows':
       Raj_Shows(url)
 
    elif mode == 'gunmoviemain':
       Gun_Movie_Menu(url)
